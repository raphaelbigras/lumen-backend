...
async function main() {
  ...
  // Map old tag names to category names
  ...
  const tickets = [
    ...
    { title: 'Wi-Fi dropping in Building B conference rooms', description: 'During meetings in rooms B201-B205, Wi-Fi drops every 10-15 minutes. Multiple people affected. Started after last weekend\'s maintenance.', status: TicketStatus.OPEN, priority: TicketPriority.HIGH, submitter: user1, dept: itDept, category: 'Réseau' },
    { title: 'Need larger monitor for design work', description: 'I\'m doing UI/UX design work and my current 22" monitor isn\'t sufficient. Requesting a 27" 4K monitor. Budget approved by my manager.', status: TicketStatus.PENDING, priority: TicketPriority.LOW, submitter: user1, dept: itDept, category: 'Matériel' },
    { title: 'Password reset for SAP account', description: 'Locked out of my SAP account after too many failed attempts. Need a password reset. Employee ID: E-4521.', status: TicketStatus.RESOLVED, priority: TicketPriority.MEDIUM, submitter: user2, dept: itDept, category: 'Accès / Permissions' },
    { title: 'Email not syncing on mobile phone', description: 'My work email stopped syncing on my iPhone since yesterday. I can access it from my laptop fine. Already removed and re-added the account.', status: TicketStatus.OPEN, priority: TicketPriority.MEDIUM, submitter: user1, dept: itDept, category: 'Messagerie' },
    ...
    { title: 'Server room AC unit making noise', description: 'The AC unit in server room A is making a loud rattling noise. Temperature is still okay (68°F) but want to get it checked before it fails.', status: TicketStatus.OPEN, priority: TicketPriority.HIGH, submitter: admin, dept: facilitiesDept, category: 'Matériel' },
    { title: 'Cannot access shared drive \\\\files\\marketing', description: 'Getting "access denied" when trying to access the marketing shared drive. I was transferred from Sales to Marketing last week and need access to campaign files.', status: TicketStatus.IN_PROGRESS, priority: TicketPriority.MEDIUM, submitter: user1, dept: itDept, category: 'Accès / Permissions' },
    { title: 'Zoom meeting room setup for Board Room', description: 'The Board Room on the 5th floor needs a permanent Zoom Rooms setup before the quarterly review on April 10th. Need camera, mic, and a display.', status: TicketStatus.OPEN, priority: TicketPriority.MEDIUM, submitter: user2, dept: itDept, category: 'Matériel' },
    { title: 'Offboarding - Mark Thompson', description: 'Mark Thompson (Engineering) last day is March 28th. Need to disable all accounts, revoke badge access, and collect laptop and equipment.', status: TicketStatus.OPEN, priority: TicketPriority.CRITICAL, submitter: admin, dept: hrDept, category: 'Accès / Permissions' },
